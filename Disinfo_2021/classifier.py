...
for date in dateList:
    ...
    csv_filepath = os.path.join('/bot_classification/probabilities', fileName_csv)
    img_filepath = os.path.join('/bot_classification/probabilities_histogram', fileName_png)
