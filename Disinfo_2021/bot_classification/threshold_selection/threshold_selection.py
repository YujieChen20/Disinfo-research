...
plt.hist(probabilities, edgecolor="black", bins=[i/100 for i in range(0, 101, 1)])
plt.yscale('log')
...
plt.savefig(os.path.join(os.path.dirname(__file__), "..", "probabilities_histogram_log_0.1.png"))
